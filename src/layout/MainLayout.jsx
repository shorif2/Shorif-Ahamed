    ...
    return (
        <div style={{
            ...
            <div className="relative z-40 max-w-screen-xl  mx-auto h-full">
                <div className="flex w-full pt-12 pb-36 h-full ">
                    <div className="w-52">
                        <div className="pb-6">
                        ...
                        <div className="flex pr-12 flex-col  space-y-1.5">
                            ...
                            <NavLink to='/skill' className=" font-sans bg-white text-center py-2 rounded-lg flex px-4 items-center gap-2"><Package size={24} />Skill</NavLink>
                            <NavLink to='/portfolio' className=" font-sans bg-white text-center py-2 rounded-lg flex px-4 items-center gap-2" ><ImageSquare size={24} />Portfolio</NavLink>
                            <NavLink to='/blog' className=" font-sans bg-white text-center py-2 rounded-lg flex px-4 items-center gap-2"><BookOpen size={24} /> Blog</NavLink>
                            <NavLink to='/contact' className=" font-sans bg-white text-center py-2 rounded-lg flex px-4 items-center gap-2" ><Chats size={24} />Contact</NavLink>
