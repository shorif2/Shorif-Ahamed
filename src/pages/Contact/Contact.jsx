...
const Contact = () => {
  return (
    <div className="w-full">
      ...
      {/* Contact Us */}
      <div className="flex flex-col md:flex-row gap-6 w-full px-6 md:px-12 pb-10  mx-auto">
        <div className="mt-12 w-full md:w-2/6 space-y-4">
          ...
          <p className="text-lg text-center md:text-start font-medium pt-6">
            My Social Profiles
          </p>
                ...
                <div className="grid grid-cols-1  sm:grid-cols-2 gap-4 lg:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="border py-3 px-4 block w-full border-gray-200  rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-black/20 backdrop-blur-md"
                    />
                  </div>
